...
<html lang="zxx">
<head>
	<title>Produk | <?= $pinstansi['nama_instansi'] ?></title>
	<meta charset="UTF-8">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-9  order-1 order-lg-2 mb-5 mb-lg-0">
									...
									<div class="store-filter clearfix">
										<ul class="store-pagination">
											...
											if($page == 1){ 
												...
												?>
												<li><a href="produk?page=1">First</a></li>
												<li><a href="produk?page=<?php echo $link_prev; ?>"><i class="fa fa-angle-double-left"></i></a></li>
												<?php
											}
											?>
											<?php 
											...
											for($i = $start_number; $i <= $end_number; $i++){
												...
												?>
												<li<?php echo $link_active; ?>><a href="produk?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
												<?php
											}
											?>
											<?php
                	...
                	?>
                	<li><a href="produk?page=<?php echo $link_next; ?>"><i class="fa fa-angle-double-right"></i></a></li>
                	<li><a href="produk?page=<?php echo $banyakpage; ?>">Last</a></li>
                	<?php
                }
                ?>
            </ul>
